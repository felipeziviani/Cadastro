        ...
        <fieldset>
            ...
            <form action="action_cliente.php" method="post" id='form-contato' enctype='multipart/form-data'>
                ...
                <div class="form-group">
                  ...
                  <input type="data_nascimento" class="form-control" id="data_nascimento" maxlength="10" name="data_nascimento" placeholder="Informe a Data de Nascimento">
                ...
                <a href='listagem_cliente.php' class="btn btn-danger">Cancelar</a>
            </form>
        </fieldset>
    </div>
