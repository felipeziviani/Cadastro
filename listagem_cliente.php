...
<head>
    ...
    <link rel="shortcut icon" href="img/clientes.ico" type="image/x-icon">
</head>
<body>
    <div class='container'>
        <fieldset>
            ...
            <legend><h1>Cadastro e Listagem de Clientes</h1></legend>
            ...
            <form action="" method="get" id='form-contato' class="form-horizontal col-md-10">
                ...
                <a href='listagem_cliente.php' class="btn btn-primary">Ver Todos</a>
            </form>
 
            <!-- Link para página de cadastro -->
            <a href='cadastro_cliente.php' class="btn btn-success pull-right">Cadastrar Cliente</a>
    ...
    <script type="text/javascript" src="js/custom_cliente.js"></script>
</body>
</html>